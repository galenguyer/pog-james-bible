...
for key, value in raw.items():
    ...
    val = rep(val, "\\bgreat\\b", "pog")
    val = rep(val, "\\bgreater\\b", "poggers")
    val = rep(val, "\\bgreatest\\b", "poggest")
    val = rep(val, "\\bgreatly\\b", "pogg\u00e8dly") # e with acute accent
    val = rep(val, "\\bgreatness\\b", "pogness")
